...
mongoose.connect('mongodb://localhost:27017/Insurance',{userNewUrlParser:true},(err)=>{
...
app.get('/agentDashboard', function (req,res) {
    // User.countDocuments({agentName: 'agent0'},function (err,c) {
    //     console.log("Count is "+ c);
    //var c=2;
...
app.post("/booker",function(req,res){
    ...
    var member={name:name,mailid:mailid,phoneno:phoneno,plan:plan};
